...
public class HarmoniousGradientController : MonoBehaviour
{
    ...
    private void Validate()
    {
        if (material == null)
        {
            material = new Material(Shader.Find("Custom/HarmoniousGradientRoundedCorners"));
        }
    ...
    {
        if (material != null && rectTransform != null)
        {
